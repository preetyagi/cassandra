...
{
    public static MTableMetadata getInstance(String keyspace, String tableName, UUID tableId)
    {
        if (DatabaseDescriptor.isPersistentMemoryEnabled())
            return new PersistentTableMetadata(keyspace, tableName, tableId);
