...
public enum VMColumnType implements MColumnType
{
    UNKNOWN, PARTITION_KEY, CLUSTERING_KEY, REGULAR, STATIC;

    public static VMColumnType getColumnType(String columnType)
    {
        switch (columnType)
        {
